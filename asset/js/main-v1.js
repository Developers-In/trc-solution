...
function loadAboutUs() {
    ...
    aboutus.innerHTML = "<span id=\"about_area\"></span>" +
...
// Service And Technology Start
function loadServiceAndTechnology() {
    let serviceandtechnology = document.getElementById('serviceandtechnology');
    serviceandtechnology.innerHTML =
...
// Footer Start
function loadFooter() {
    let projectdetails = document.getElementById('footer');
