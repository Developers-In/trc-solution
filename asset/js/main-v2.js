...
function loadCarousal() {
    var caro = document.getElementById("main-carousal")
    caro.innerHTML = "<!-- Carousel Start -->\n" +
...
function loadAboutUs() {
    var abus = document.getElementById("about-us")
    abus.innerHTML = "<!-- About Us Content Start -->\n" +
...
function loadServiceTech() {
    var servetech = document.getElementById("serv-tech")
    servetech.innerHTML = "<!-- Services & Technologies Content Start -->\n" +
...
function loadContactUs() {
    ...
    contact.innerHTML = "<!-- Contact Us Content Start -->\n" +
...
function loadFooter() {
    ...
    foot.innerHTML = "<!-- Footer Area Start -->\n" +
        "<div class=\"container-fluid p-0\">\n" +
